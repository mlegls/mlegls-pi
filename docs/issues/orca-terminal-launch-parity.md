...
Check `/fork-tab` creates a visible sibling tab without switching or mutating the original Pi session. Check worker setup/launch and board steering, plus visible reader success, compaction, structured submission, abort, and timeout.
