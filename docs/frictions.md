...
Resolved reports and reproduction evidence: [2026-09-16 verification](research/exec-friction-verification-2026-09-16.md). Unverified reports from a day of multi-agent dispatch, by frequency: [2026-09-16 reports](research/exec-friction-reports-2026-09-16.md); the edit anchor grammar is the largest, with one silently lost edit.
