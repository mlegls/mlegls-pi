...
description: "Use when an instruction or correction recurs."
...
- **Route to the right layer.** One-off -> memory note. Recurring fix -> skill or lint rule. Systemic issue -> principle.
