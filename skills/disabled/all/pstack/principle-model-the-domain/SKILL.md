...
description: "Use when writing stateful logic or encountering repeated conditionals or shape assumptions."
...
Documentation counterpart: the `domain-modeling` skill (CONTEXT.md glossary, ADRs) — the terms encoded here should be defined there.
