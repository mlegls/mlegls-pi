...
| <new pattern, no existing skill is a real home> | <draft a new skill through writing-for-llms> | <new skill: <kebab-name>> |
...
For each item, describe the pattern, what was hit, and the suggested mechanism. The parent appends each to `BACKLOG.md` at the root of the skills repo.
