---
name: tdd
description: "Use only for explicit TDD or failing/regression-test requests, or bugs with cheap, obvious local test targets; skip unclear or costly test paths."
