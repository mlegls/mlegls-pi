...
2. Use `grill` to settle the intended affordance sequence, consequential choices and shared interfaces. Sketch the program with `show-me` where useful. Stories hold intended outcomes; the spec holds implementation shape and unresolved holes.
