...
4. Integrate changes, hand runnable setup to `verify-story` over affected stories for first use, guide/recording updates and reviewed replay, and reconcile issues and dependencies against the evidence. Route in-contract repairs to workers; changed contracts to shaping. Explicitly dispose of findings. Landed is not yet verified; close against acceptance.
