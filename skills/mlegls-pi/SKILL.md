...
canonical checkout `~/dev/mlegls-pi`. worktrees under `~/dev/mlegls-pi__worktrees/`. pi-package: `extensions/`, `lib/`, `skills/`, `prompts/`, `themes/`. cell API: `extensions/exec/README.md`.
