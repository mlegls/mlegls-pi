...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		description: [
			...
			"Output is read with attention to the conversation: skimmed or omitted parts carry an ing-… id that ab pull recovers. ab pull output arrives exact; for any other command, CMD | ab raw, or ab raw CMD ARG… to include its stderr and exit status. raw: true makes the whole call exact; focus names what to look for. Long output keeps head and tail; the full log path is shown.",
